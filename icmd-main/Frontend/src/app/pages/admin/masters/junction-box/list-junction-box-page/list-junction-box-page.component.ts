...
import { importJunctionBoxColumns, masterJunctionBoxListTableColumn } from "@u/constants";
...
import { JunctionBoxDialogsService, JunctionBoxSearchHelperService, JunctionBoxService } from "src/app/service/junction-box";
...
export class ListJunctionBoxPageComponent extends FormBaseComponent<SearchProjectFilterModel> {
    ...
    protected onFileSelected(event: any): void {
        ...
        this._junctionBoxService.importJunctionBox(this.projectId, selectedFile).pipe(takeUntil(this._destroy$))
            .subscribe({
                next: (res) => {
                    if (res && res.isSucceeded) {
                        this._toastr.success(res.message);
