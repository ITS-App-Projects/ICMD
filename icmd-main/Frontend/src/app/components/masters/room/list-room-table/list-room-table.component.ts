...
import { RoomListDtoModel } from "./list-room-table.model";
import { masterRoomListTableColumn } from "@u/constants";

@Component({
    standalone: true,
    selector: "app-list-room-table",
    templateUrl: "./list-room-table.component.html",
    imports: [
        FormDefaultsModule,
        MatTableModule,
        MatSortModule,
...
export class ListRoomTableComponent {
    ...
    @Input() dataSource: MatTableDataSource<RoomListDtoModel>;
    @Input() totalLength: number = 0;

    public displayedColumns = [...masterRoomListTableColumn].map(x => x.key);
    ...
    @Input() public set items(value: ReadonlyArray<RoomListDtoModel>) {
